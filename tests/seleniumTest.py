...
class TestScoring(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        # disable execution in alphabatic order
        unittest.TestLoader.sortTestMethodsUsing = None

        cls.driver = webdriver.Chrome()
        cls.scoringURL = 'http://localhost:8080/home/-N3hlhMMtjy-u_QrqVL8/team/-NTd4gODlBQPL9Na1VYr/scoring/-NWWfIucoWbL8SOyZGSw'
        cls.analysisURL = 'http://localhost:8080/home/-N3hlhMMtjy-u_QrqVL8/team/-NTd4gODlBQPL9Na1VYr/record/-NWWfIucoWbL8SOyZGSw'
    ...
    def test_we_score(self):
        ...
        WebDriverWait(self.driver, 3).until(
            expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, "#record-tab-pane > div > div:nth-child(1) > div.card-body.text-center > div.d-grid.team-members-grid > button:nth-child(1)")))
        ...
        # select a member
        self.driver.find_element(By.CSS_SELECTOR, "#record-tab-pane > div > div:nth-child(1) > div.card-body.text-center > div.d-grid.team-members-grid > button:nth-child(1)").click()
    ...
    def test_delete_their_history(self):
        ...
        WebDriverWait(self.driver, 3).until(
            expected_conditions.visibility_of_element_located((By.XPATH,
                                                               '//*[@id="history-tab-pane"]/div[2]/table'))
        )
